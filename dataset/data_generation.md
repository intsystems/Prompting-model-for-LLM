...
Вышла версия 2.5, но для генерации я использовала Qwen2-7B-Instruct, так как иначе слишком тяжёлая и медленная модель [скорость и память](https://qwen.readthedocs.io/en/latest/benchmark/speed_benchmark.html). Примеры генерации занесены в таблицу.
